...
describe UsersController do
  ...
  describe "POST 'create '" do
    ...
    # a test for creating user successfully
    describe "success" do
      before(:each) do
  ...
  describe "GET 'edit'" do
    before(:each) do
      @user=Factory(:user)
      #to sign an user in anticipation of ptrotecting page for unauthenticated access
      test_sign_in(@user)
    end
    ...
    it "should have a link to change the gravetar " do
      get :edit ,:id=>@user
  ...
  describe "authenticate of edit/update" do
     ...
     describe "for no-signed0in users" do
	...
	it "should deny access to 'update '" do
     ...
     describe "for signed-in users" do
       before(:each) do
         wrong_user=Factory(:user,:email=>"uer@example.com")
